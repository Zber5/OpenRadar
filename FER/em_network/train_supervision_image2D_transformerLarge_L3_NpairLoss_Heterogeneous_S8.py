...
if __name__ == "__main__":
    ...
    path = dir_path("Supervision_SUM_image2D_TransformerLarge_L3_CrossNpairLossWeighted_S8_v1_allbpTeacher", result_dir)
    ...
    v_train_ann = os.path.join(videos_root, 'video_annotation_train_S8_v1.txt')
    v_test_ann = os.path.join(videos_root, 'video_annotation_test_S8_v1.txt')

    heatmap_root = "C:/Users/Zber/Desktop/Subjects_Heatmap\\"
    h_train_ann = os.path.join(heatmap_root, "heatmap_annotation_train_S8_v1.txt")
    h_test_ann = os.path.join(heatmap_root, "heatmap_annotation_test_S8_v1.txt")
    ...
    # checkpoint = os.path.join(result_dir, "Pretrained_ResNet_video_S8_allBP_20220313-192941", 'model_best.pth.tar')
    checkpoint = os.path.join(result_dir, "Pretrained_ResNet_video_S8_classifierBP_20220313-194822", 'model_best.pth.tar')

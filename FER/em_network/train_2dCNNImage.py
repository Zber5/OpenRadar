...
from models.Conv2D import ImageSingle, ImageDualNet_Single, ImageNet_Large
...
if __name__ == "__main__":
    ...
    # log path
    path = dir_path("sensor_heatmap_ImageSingle_v2", result_dir)

    # create model
    model = ImageSingle(num_classes=config['num_classes'], block=ImageDualNet_Single, subblock=ImageNet_Large)
    model = model.to(device)

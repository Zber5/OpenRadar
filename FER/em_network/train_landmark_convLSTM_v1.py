...
from models.ConvLSTM1D import LandmarkConvLSTM
...
if __name__ == "__main__":
    ...
    # log path
    path = dir_path("landmark_ConvLSTM_xy_v1", result_dir)

    # create model
    model = LandmarkConvLSTM(input_dim=config['num_channels'],

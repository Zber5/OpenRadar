...
if __name__ == "__main__":
    ...
    block_checkpoint = os.path.join(result_dir, best_folder, 'block.pth.tar')
    ...
    # classifier_checkpoint = os.path.join(result_dir, best_folder, 'classifier.pth.tar')
    ...
    for i, conc_data in enumerate(train_loader):
        ...
        # t_fmap = m(t4)
        t_fmap = torch.mean(t4, dim=(1,3,4))

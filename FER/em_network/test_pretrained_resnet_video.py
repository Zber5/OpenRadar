...
if __name__ == "__main__":
    ...
    path = dir_path("Evaluate_camera_pose_outputs", result_dir)
    ...
    # annotation_test = os.path.join(videos_root, 'frames_test_Camera.txt')
    annotation_test = os.path.join(videos_root, 'frames_test_Pose.txt')
    # dataloader

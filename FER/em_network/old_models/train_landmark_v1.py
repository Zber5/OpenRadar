...
from models.Conv1D import LandmarkNet, Classifier, SubNet1D
...
if __name__ == "__main__":
    ...
    # log path
    path = dir_path("landmark_conv1d_xyz_v2", result_dir)

    # create model
    model = LandmarkNet(subnet=SubNet1D, classifier=Classifier, num_channel=config['num_channels'],

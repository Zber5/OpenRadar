...
from models.Attention_3D import C3DFusionAttention
...
if __name__ == "__main__":
    ...
    # log path
    path = dir_path("sensor_heatmap_3dcnn_fusion_attention_SpatialSELayer3D", result_dir)

    # create model
    model = C3DFusionAttention(sample_duration=config['h_num_frames'], num_classes=config['num_classes'])

...
from models.Conv2D import ImagePhaseNet_Single, ImagePhaseLSTM_Single_v1
...
if __name__ == "__main__":
    ...
    phase_train = PhaseDataset(phase_root, annotation_train, flatten=True)
    phase_test = PhaseDataset(phase_root, annotation_test, flatten=True)
    ...
    # log path
    path = dir_path("ImagePhaseLSTM_Single_v1", result_dir)

    # create model
    model = ImagePhaseLSTM_Single_v1(input_size=config['input_size'], hidden_size=config['hidden_size'],

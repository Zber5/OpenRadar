...
if __name__ == "__main__":
    ...
    # path = dir_path("Supervision_SUM_image2D_TransformerLarge_L3_CrossNpairLossWeighted_S5_small_olddata", result_dir)
    path = dir_path("Ours_newDataNorm_Focus_Pose", result_dir)
    ...
    # v_train_ann = os.path.join(videos_root, 'video_annotation_train_S5.txt')
    # v_test_ann = os.path.join(videos_root, 'video_annotation_test_S5.txt')
    #
    # heatmap_root = "C:/Users/Zber/Desktop/Subjects_Heatmap_new"
    # h_train_ann = os.path.join(heatmap_root, "heatmap_annotation_train_S5.txt")
    # h_test_ann = os.path.join(heatmap_root, "heatmap_annotation_test_S5.txt")
    ...
    heatmap_root = "C:/Users/Zber/Desktop/Subjects_Heatmap_Pose"
    ...
    train_loader = DataLoader(dataset_train, num_workers=4, pin_memory=True, shuffle=True,

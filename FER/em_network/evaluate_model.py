...
if __name__ == "__main__":
    ...
    model_path = "FER/results/sensor_imag_basic20210827-210657/model.ckpt"

    # load data
    sensor_data_path = 'FER/data/sensor_b8_c5_x.npy'
    flm_score_path = 'FER/data/flm_score.npy'
    label_path = 'FER/data/sensor_b8_c5_y.npy'

...
if __name__ == '__main__':
    ...
    save_path = '//data/emotion_3s_diff_all_bi{}_{}.npy'
    ...
    data = np.zeros((num_data, len(antenna_order), numSample))
    ...
    np.save(save_path.format(bin_index, 'x'), data)
    np.save(save_path.format(bin_index, 'y'), label)
    print("Finished")

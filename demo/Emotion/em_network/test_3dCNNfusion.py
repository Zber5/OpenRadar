...
from demo.Emotion.em_network.utils import twin_sliding_window, device, AverageMeter, dir_path, write_log, \
    senor_heatmap_label_data_loader, accuracy, normalise_data
from models.autoencoder import EMOEncode, EMODecode
from demo.Emotion.em_network.models.c3d import C3DFusionBaseline
...
if __name__ == "__main__":
    ...
    model_path = "demo/Emotion/results/sensor_heatmap_3dcnn_fusion20211030-123808/model.ckpt"
